...
<div>
    ...
    <section class="p-5 d-flex justify-content-center" style="font-size:1.2rem; margin-top:-55rem"><a class="text-secondary" style="text-decoration: none" href="{{ route('homePage') }}">Home</a><span class="mx-3 text-secondary">></span><p class="m-0 p-0 text-dark">Inserisci annuncio</p></section>
    <div class="modal d-flex flex-column">
        <h1 class="w-25 ms-3 mb-3" style="font-size:3rem; letter-spacing:-3px">Inserisci il tuo annuncio</h1>
